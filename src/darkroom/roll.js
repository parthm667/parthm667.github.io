...
export const ROLL = [
  {
    ...
    note: 'the only one\nI didn\'t take',
    print: {
      deck: 'Computer science and applied mathematics at the University of Maryland, class of 2027.',
      body: [
      ...
      stat: [['SCHOOL', 'UMD'], ['CLASS', '2027'], ['NOW', 'Corsha'], ['SEEKING', 'S27 intern']],
  ...
  },
  {
    ...
    id: 'unexposed',
    title: 'Unexposed',
    subject: 'Open: summer 2027',
    role: 'July 2026',
    kind: '—',
    gen: 'unexposed',
    exposure: 'OPEN · SUMMER 2027 · QUANT RESEARCH OR SYSTEMS',
    note: 'on purpose',
    print: {
      deck: 'One frame left on the roll, on purpose.',
      body: [
        'Every roll should end with one you did not spend. This is that one, and what it is waiting for is a summer 2027 internship in quantitative research or systems engineering.',
        'If you have one of those, my email is in the correspondence section below.',
      ],
      stat: [['STATUS', 'open'], ['WANT', 'quant · systems'], ['WHEN', 'Summer 2027'], ['FRAME', 'unspent']],
